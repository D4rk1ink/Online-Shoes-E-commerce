            ...
            <div class="product-form">
                <form action="" method="POST" id="target-form" enctype="multipart/form-data">
                            ...
                            <div class="grid-4">
                                <select class="form-input" name="product-brand" id="product-brand">
                                    <% for(Map brand : brands){ %>
                                        <option value="<%= brand.get("brand_id") %>"><%= brand.get("brand_name") %></option>
                                    <% } %>
                                </select>
                            </div>
                            <div class="grid-2">
                            ...
                            <div class="grid-4">
                                <select class="form-input" name="product-person" id="product-person">
                                    <% for(Map person : persons){ %>
                                        <option value="<%= person.get("person_id") %>"><%= person.get("person_name") %></option>
                                    <% } %>
                                </select>
                            </div>
                        </div>
                    ...
                    <div  class="form-group">
                        ...
                        <div class="grid-10">
                            <textarea class="textarea-product-detail" name="product-detail" id="product-detail"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
